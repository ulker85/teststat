...
<div id="container">
    ...
    <div id="content">
        ...
        <form name="adminForm" action="types.php" method="post" enctype="multipart/form-data">
        <input type="hidden" name="mode" />
            
        <h2>Типи звітності</h2>
        ...
        <table>
          ...
          <tr>
            ...
            <td><input name="name_<?php echo $v['id']; ?>" type="text"  value="<?php echo $v['name']; ?>" onchange="chkOn('chk_<?php echo $v['id']; ?>')" /></td>
        ...
        <div id="addForm">
            <h2>Додати новий тип</h2>
            
            <form name="subAdminForm" action="types.php" method="post">
            <input type="hidden" name="mode" />
