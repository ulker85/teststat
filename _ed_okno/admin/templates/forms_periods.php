...
<div id="container">
    ...
    <div id="content">
        ...
        <h2>Відповідність періодів формам</h2>
        ...
        <table>
          <tr class="class_TH">
            <th>Id</th>
            <th>Назва форми</th>
            <th>Назва періоду звіта</th>
            <th>Назва логічного періоду</th>
            <th>&nbsp;<br />&nbsp;</th>
          </tr>
        ...
        <div id="addForm">
        <h2>Додати нову відповідність</h2>
        ...
        <table width="400" border="0">
          ...
          <tr>
            <td>Назва періоду звіта</td>
            <td><select name="period_r"><?php echo $period_r; ?></select></td>
          </tr>
          <tr>
            <td>Назва логічного періоду</td>
