...
<div id="container">
    ...
    <div id="content">
        ...
        <form name="adminForm" action="periods_report.php" method="post" enctype="multipart/form-data">
        <input type="hidden" name="mode" />
            
        <h2>Періоди звітів</h2>
        ...
        <table>
          ...
          <tr>
            ...
            <td>
                <select name="year_<?php echo $v['id']; ?>" style="width:90px"
                		onchange="chkOn('chk_<?php echo $v['id']; ?>')">
                    <?php echo $v['year']; ?>
                </select>
            </td>
        ...
        <div id="addForm">
            <h2>Додати новий період</h2>
            
            <form name="subAdminForm" action="periods_report.php" method="post">
            <input type="hidden" name="mode" />
            ...
            <table width="400" border="0">
              ...
              <tr>
                <td>Рік періоду</td>
                <td><select name="year"><?php echo $year; ?></select></td>
              </tr>
              <tr>
