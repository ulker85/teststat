...
<div id="container">
    ...
    <div id="content">
        ...
        <form name="adminForm" action="periods_form.php" method="post" enctype="multipart/form-data">
        ...
        <div id="addForm">
            ...
            <form name="subAdminForm" action="periods_form.php" method="post">
            <input type="hidden" name="mode" />
