...
unset($_SESSION['type_report']);
unset($_SESSION['form']);
unset($_SESSION['period']);
	
if ($action) {
	if ($action == 'search_edok') {
		$_SESSION['type_report'] = 3;
	} else if ($action == 'search_kanc') {
		$_SESSION['type_report'] = 2;
	} else if ($action == 'search_depart') {
		$_SESSION['type_report'] = 5;
	}
