...
<title>Головна (коригування)</title>
...
<div id="container">
    ...
    <div id="content">
        ...
        <form name="adminForm" action="index_kor.php" method="post" enctype="multipart/form-data">
        ...
        <div class="item_beige" style="margin-top:11%; margin-left:40%">
            ...
            <fieldset>
                ...
                <input type="text" name="edrpou" value="<?php echo $edrpou; ?>"
                          style="width:256px"
                          onkeypress="checkForEnter(event, 'search')" />
            </fieldset>
            ...
            <p align="center">
                <input type="button" value="Пошук звітності" class="button" onclick="submitForm('search')" />
            </p>    
        </div>
